...
class Prabhatiya extends StatefulWidget {
  const Prabhatiya({Key? key}) : super(key: key);

  @override
  _PrabhatiyaState createState() => _PrabhatiyaState();
}

class _PrabhatiyaState extends State<Prabhatiya> {
  ...
  void fetchUrl() async {
    try {
      var response = await http.get(Uri.parse(AppUrl.prabhatiyaApi),headers: {
